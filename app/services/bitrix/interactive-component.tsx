            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mt-12 space-y-4">
                    <details className="group rounded-3xl border border-white/10 bg-white/[.06] p-6 open:bg-white/[.09]">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-black"><h3>Почему стоит выбрать 1С-Битрикс для разработки сайта?</h3><span className="text-cyan-200 group-open:rotate-45">+</span></summary>
                    ...
                    <details className="group rounded-3xl border border-white/10 bg-white/[.06] p-6 open:bg-white/[.09]">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-black"><h3>Сколько стоит разработка сайта на 1С-Битрикс?</h3><span className="text-cyan-200 group-open:rotate-45">+</span></summary>
                    ...
                    <details className="group rounded-3xl border border-white/10 bg-white/[.06] p-6 open:bg-white/[.09]">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-black"><h3>Нужно ли покупать лицензию 1С-Битрикс?</h3><span className="text-cyan-200 group-open:rotate-45">+</span></summary>
                    ...
                    <details className="group rounded-3xl border border-white/10 bg-white/[.06] p-6 open:bg-white/[.09]">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-black"><h3>Можно ли интегрировать сайт с 1С и другими сервисами?</h3><span className="text-cyan-200 group-open:rotate-45">+</span></summary>
                    ...
                    <details className="group rounded-3xl border border-white/10 bg-white/[.06] p-6 open:bg-white/[.09]">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-black"><h3>Занимаетесь ли вы поддержкой и доработкой существующих сайтов на Битрикс?</h3><span className="text-cyan-200 group-open:rotate-45">+</span></summary>
