...
export const metadata: Metadata = {
  title: 'Разработка сайтов на Bitrix и React в Тольятти | Данила Мохнаткин',
  description: 'Создание сайтов под ключ на Bitrix и React. Разработка корпоративных сайтов, интернет-магазинов и лендингов. Интеграция CRM, SEO, техническая поддержка. Работаю в Тольятти и по всей России.',
